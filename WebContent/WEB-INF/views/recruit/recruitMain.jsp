	...
	$j(document).ready(function() {
		...
		$j("#educationAdd").on("click", function() {
			var educationTag = 
				"<tr>
					<td align='center'>
						<input type='checkbo' id="education"/>
					</td>
					<td>
			 ...
			 $j("#education").closest("tr").after(educationTag);
		});
...
<body>
	<form action="/recruit/main" method="POST" accept-charset="UTF-8">
				...
				<td align="center" style="border: none;">
					<table align="center" border="2">
						...
						<tr align="center" style="font-weight: bold;">
							...
							<td align="left"><select name="recruitVo.location"
							...
							<td align="left"><select name="workType"
								value="${recruit.workType}">
			...
			<tr>
				<td style="border: none;">
					<table width="900" align="center" border="2">
						...
						<tr>
							<td align="center"><input type="checkbox" id="education" />
							</td>
							<td><input type="text" name="educationVo.startPeriod"
								value="${education.startPeriod}" /><br /> ~<br /> <input
								type="text" name="educationVo.endPeriod"
								value="${education.endPeriod}" /></td>
							...
							<td><input type="text" name="schoolName"
								...
								name="educationVo.location" value="${education.location}">
									<option value="서울">서울</option>
									<option value="경기">경기</option>
									<option value="강원">강원</option>
									<option value="전라도">전라도</option>
							...
							<td><input type="text" name="major"
								value="${education.major}" /></td>
							<td><input type="text" name="grade"
								value="${education.grade}" /></td>
						</tr>
					</table>
				</td>
			</tr>
			...
			<tr>
				<td style="border: none;">
					<table width="900" align="center" border="2">
						...
						<tr>
							<td><input type="checkbox" id="career" /></td>
							<td><input type="text" name="careerVo.startPeriod"
								value="${career.startPeriod}" />~<br /> <input type="text"
								name="careerVo.endPeriod" value="${career.endPeriod}" /></td>
							<td><input type="text" name="compName"
								value="${career.compName}" /></td>
							<td><input type="text" name="task" value="${career.task}" />
							</td>
							<td><input type="text" name="careerVo.location"
								value="${career.location}" /></td>
						</tr>
					</table>
				</td>
			</tr>
			...
			<tr>
				<td style="border: none;">
					<table width="900" align="center" border="2">
						...
						<tr>
							<td><input type="checkbox" id="certificate" /></td>
							<td><input type="text" name="qualifiName"
								value="${certificate.qualifiName}" /></td>
							<td><input type="text" name="acquDate"
								value="${certificate.acquDate}" /></td>
							<td><input type="text" name="organizeName"
								value="${certificate.organizeName}" /></td>
						</tr>
					</table>
				</td>
			</tr>
